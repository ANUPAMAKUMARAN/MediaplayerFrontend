...
function Videocard({videoDetails,setdeleteStatus,  present}) {
  ...
  return (
     <>
      ...
      {!present && <Card.Img  onClick={handleShow} variant="top" src={videoDetails?.imageurl} style={{height:'300px'}} />}
